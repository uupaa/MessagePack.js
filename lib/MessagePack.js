...
})("MessagePack", function moduleClosure(global) {
"use strict";

// --- dependency modules ----------------------------------
var UTF8 = global["WebModule"]["UTF8"];
...
var MessagePack = {
    ...
    "repository": "https://github.com/uupaa/MessagePack.js", // GitHub repository URL.
};
...
function _decodeMessagePack(source, // @arg Uint8Array
    ...
    case TYPE_FIX_STR:
        ...
        try {
            ...
            return UTF8["decode"](u8, true); // UTF8 Uint8Array to String
        }
        break;
    case TYPE_ARRAY32:
    case TYPE_ARRAY16:
...
return MessagePack; // return entity
